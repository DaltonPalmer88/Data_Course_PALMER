...
unicef_data <- read.csv("../Data_Course_PALMER/exam 2/unicef-u5mr.csv")
head(unicef_data)
str(unicef_data)
View(unicef_data)
...
plot1
# 4. Save this plot####
ggsave("PALMER_Plot_1.png", plot1, width = 12, height = 8, dpi = 300)
...
plot2
# 6. Save that plot####
ggsave("PALMER_Plot_2.png", plot2, width = 10, height = 6, dpi = 300)
...
# Because this model accounts for the overall trend as well as how that trend changes across continents
...
ggsave("PALMER_Plot_3.png", plot3, width = 14, height = 10, dpi = 300)
...
ggsave("PALMER_Plot_Ecuador_Prediction.png", plot4, width = 10, height = 6, dpi = 300)
